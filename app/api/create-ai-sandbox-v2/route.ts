...
export async function POST() {
  try {
    ...
    console.error('[create-ai-sandbox-v2] Error details:', error.message, error.stack, error);
    ...
    return NextResponse.json(
      { 
        ...
        fullError: JSON.stringify(error, Object.getOwnPropertyNames(error)) // Include full error object
      },
      { status: 500 }
    );
  }
