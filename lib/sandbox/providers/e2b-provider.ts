...
export class E2BProvider extends SandboxProvider {
  ...
  async runCommand(command: string): Promise<CommandResult> {
    ...
    const result = await this.sandbox.runCode(`
      ...
      os.chdir('/home/user/packages/create-codinit-app')
  ...
  async writeFile(path: string, content: string): Promise<void> {
    ...
    const fullPath = path.startsWith('/') ? path : `/home/user/packages/create-codinit-app/${path}`;
  ...
  async listFiles(directory: string = '/home/user/packages/create-codinit-app'): Promise<string[]> {
    if (!this.sandbox) {
      throw new Error('No active sandbox');
    }
...
try:
    os.makedirs('/home/user/packages/create-codinit-app/src', exist_ok=True)
...
try:
    with open('/home/user/packages/create-codinit-app/package.json', 'w') as f:
...
with open('/home/user/packages/create-codinit-app/vite.config.js', 'w') as f:
    f.write(vite_config)
...
with open('/home/user/packages/create-codinit-app/tailwind.config.js', 'w') as f:
...
with open('/home/user/packages/create-codinit-app/postcss.config.js', 'w') as f:
...
with open('/home/user/packages/create-codinit-app/index.html', 'w') as f:
    f.write(index_html)
print('✓ index.html')
...
with open('/home/user/packages/create-codinit-app/src/main.jsx', 'w') as f:
    f.write(main_jsx)
print('✓ src/main.jsx')
...
with open('/home/user/packages/create-codinit-app/src/App.jsx', 'w') as f:
    f.write(app_jsx)
print('✓ src/App.jsx')
...
with open('/home/user/packages/create-codinit-app/src/index.css', 'w') as f:
    f.write(index_css)
print('✓ src/index.css')
...
result = subprocess.run(
    ['npm', 'install'],
    cwd='/home/user/packages/create-codinit-app',
    capture_output=True,
    text=True
)
...
if result.returncode == 0:
    ...
    print(f'❌ Error: npm install failed with return code {result.returncode}')
...
print('Killing any existing Vite processes...')
subprocess.run(['pkill', '-f', 'vite'], capture_output=True)
time.sleep(1)
print('Existing Vite processes killed (if any).')
